...
public class ScontoStadioFrame extends JFrame implements Serializable {
	...
	public void createComboPartite() {
		...
		if (scegliStadio.getItemCount() == 0) {
			JOptionPane.showMessageDialog(scegliStadio, "Spiacenti, nessuno stadio presente nel sistema.",
					"Nessuno stadio presente nel sistema.", JOptionPane.ERROR_MESSAGE);
		} else {
