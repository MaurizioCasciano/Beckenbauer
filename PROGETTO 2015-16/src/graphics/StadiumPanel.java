...
public class StadiumPanel extends JPanel implements Serializable {
	 ...
	 * @param stadiumMode
	 *            La modalit� con cui si vuole accedere allo Stadio.
	 * @author Maurizio
	 */
	 ...
	 * settore � rappresentato da un {@link JButton} contenente un
	 ...
	 * @param mousePosition
	 *            La posizione del mouse quando � stato generato il
	 *            MouseWheelEvent.
	 */
	protected void updatePreferredSize(JComponent component, double preciseWheelRotation, Point mousePosition) {
		...
		/**
		 * Calcola le nuove coordinate del componente affinch� il mouse rimanga
